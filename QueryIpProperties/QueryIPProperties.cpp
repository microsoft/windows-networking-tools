...
{
	wprintf(
		L"QueryIPProperties.exe\n"
		L"Reads and displays the properties of MSFT_NetIPInterface from a specified network interface.\n"
		L"\n"
		L"Usage: QueryIPProperties.exe <InterfaceIndex>\n"
		L"     : InterfaceIndex specifies the index of the network interface to query\n");
}
